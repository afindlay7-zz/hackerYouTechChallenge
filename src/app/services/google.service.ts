...
export class GoogleService {
  geolocationBaseURL:string = 'https://www.googleapis.com/geolocation/v1/geolocate?';
  ...
  getGeolocation(): Observable<string>{
    this.geolocationObeservable = this.http.post(this.geolocationBaseURL + this.googleAPIKey, this.geolocationRequestBody)
